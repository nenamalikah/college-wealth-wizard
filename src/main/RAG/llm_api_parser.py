...
parser = PydanticOutputParser(pydantic_object=API)

#%%

def parse_query_to_api_params(query, parser):
...
#%%
def api_params_to_call(param_dict):
...
#%%
param_dictionary = parse_query_to_api_params("What is the median salary of students at Georgetown University six years after enrollment?",parser)
api_results = api_params_to_call(param_dictionary)
print(api_results)
